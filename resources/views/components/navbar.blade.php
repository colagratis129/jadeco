...
<div class="ud-header absolute left-0 top-0 z-40 flex w-full items-center bg-transparent" >
    <div class="container">
        <div class="flex items-center relative -mx-4 justify-between">
            <div class="w-60 max-w-full px-4">
                <a href="/" class="navbar-logo block w-full py-5">
                    <img
                        src="{{ 'storage/'.setting('general.logo_white') }}"
                        alt="logo"
                        class="header-logo w-full"
                    />
                </a>
            </div>
            <div class="flex items-center px-4 justify-between space-x-4">
                <div>
                    <button
                        id="navbarToggler"
                ...
                ></span>
                    ...
                    >
                        <ul class="blcok lg:flex 2xl:ml-20">
                            @foreach(setting('header.links') as $link)
